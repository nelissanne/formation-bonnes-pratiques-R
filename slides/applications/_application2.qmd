...
7. (Facultatif) Initialiser un nouveau projet sur `GitLab` est y mettre le code du *package*. Vérifier que le *package* peut être installé en local avec la fonction `devtools::install_git()`.
:::
